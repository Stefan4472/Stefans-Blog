...
from stefan_on_software_api_client.models.post_commands_publish_json_body import PostCommandsPublishJsonBody
from stefan_on_software_api_client.models.post_commands_unpublish_json_body import PostCommandsUnpublishJsonBody
from stefan_on_software_api_client.models.post_commands_feature_json_body import PostCommandsFeatureJsonBody
from stefan_on_software_api_client.models.post_commands_unfeature_json_body import PostCommandsUnfeatureJsonBody
from stefan_on_software_api_client.models.post_tags_json_body import PostTagsJsonBody
from stefan_on_software_api_client.models.put_tags_tag_json_body import PutTagsTagJsonBody
...
@click.option('--email', required=True, help='Email address used to authenticate with the API')
@click.password_option(required=True)
@click.option('--host_url', required=True, help='Host URL of the site instance, e.g. http://localhost:5000')
def publish_post(
        post_id: int,
        send_email: bool,
        email: str,
