...
from stefan_on_software_api_client.models.put_posts_post_id_json_body import PutPostsPostIdJsonBody
...
def update_post(post_id: int, path: Path, email: str, password: str, host_url: str):
    ...
    for filename in renderer.markdown.find_images(post_md):
        ...
        with open(full_path, mode='rb') as contents:
            ...
            new_filename = client_util.upload_file(client, UploadFile(contents, full_path.name)).upload_name
