...
from ...models.post_commands_unfeature_json_body import PostCommandsUnfeatureJsonBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: PostCommandsUnfeatureJsonBody,
) -> Dict[str, Any]:
    url = "{}/commands/unfeature".format(client.base_url)
