...
class Tokenizer:
    ...
    def tokenize(self, filepath):
        ...
        for token in self._get_next_unprocessed_token(filepath):
            # ignore if stopword
    ...
    # generator for unprocessed tokens read from the textfile
    def _get_next_unprocessed_token(self, filepath):
