...
def test_get_all(client: FlaskClient):
    ...
    response1 = util.upload_file(client, DEFAULT_USER, get_example_file(ExampleFileType.Txt))
    response2 = util.upload_file(client, DEFAULT_USER, get_example_file(ExampleFileType.Jpg))
    response3 = util.upload_file(client, DEFAULT_USER, get_example_file(ExampleFileType.Png))
...
def test_download(client: FlaskClient):
    ...
    response_download = util.download_file(client, DEFAULT_USER, response_upload.json["id"])
