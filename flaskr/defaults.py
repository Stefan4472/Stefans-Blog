...
def make_defaults(instance_path: str) -> Dict:
    ...
    return {
        ConfigKeys.SQLALCHEMY_DATABASE_URI: "sqlite:///"
        + os.path.join(instance_path, DATABASE_REL_PATH),
        ...
        ConfigKeys.SEARCH_INDEX_PATH: os.path.join(
            instance_path, SEARCH_INDEX_REL_PATH
        ),
    }
